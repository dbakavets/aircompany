...
public class AirportTest {
    private static List<Plane> planes = Arrays.asList(
            ...
            new ExperimentalPlane("Ryan X-13 Vertijet", 560, 307, 500, ExperimentalPlaneType.VERTICAL_TAKE_OFF_LANDING, ClassificationPlaneLevel.TOP_SECRET)
    );
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        for (int i = 0; i < planesSortedByMaxLoadCapacity.size() - 1; i++) {
            ...
            if (currentPlane.getPlaneMaxLoadCapacity() > nextPlane.getPlaneMaxLoadCapacity()) {
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        for(ExperimentalPlane experimentalPlane : experimentalPlanes){
            if(experimentalPlane.getClassificationPlaneLevel() == ClassificationPlaneLevel.UNCLASSIFIED){
